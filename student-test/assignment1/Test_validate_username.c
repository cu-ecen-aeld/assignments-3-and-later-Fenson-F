...
void test_validate_my_username()
{
     ...
     */
     ...
     char *malloc_username = malloc_username_from_conf_file();
     
     if (strcmp(hard_coded_username, malloc_username) == 0)	
    	TEST_ASSERT_EQUAL_STRING_MESSAGE(hard_coded_username,malloc_username,"Username do not match"); 
    else{
